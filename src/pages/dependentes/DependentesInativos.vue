    ...
    <div v-else class="bg-white rounded-lg border border-neutral-200 shadow-sm overflow-hidden">
      <div class="px-6 py-4 border-b border-neutral-200 bg-red-50">
        <h2 class="text-sm font-semibold text-red-900">
          Inativos <span class="text-red-700 font-normal">({{ dependentesStore.dependentesInativos.length }})</span>
        </h2>
      </div>
      ...
      <div v-else class="overflow-x-auto">
        <table class="w-full">
          ...
          <tbody class="divide-y divide-neutral-200">
            <tr v-for="(dependente, index) in dependentesStore.dependentesInativos" :key="dependente.id" class="hover:bg-neutral-50 transition-colors">
