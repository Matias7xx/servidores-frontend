<template>
  <div>
    ...
    <!-- Erro -->
    <div v-if="dependentesStore.error" class="bg-red-50 border border-red-200 rounded-lg p-4">
              ...
              <td class="px-3 py-3 sm:px-6 sm:py-4">
                <div class="flex flex-col gap-1.5">
                  ...
                  <button
                    ...
                    class="inline-flex items-center gap-1.5 text-xs font-medium text-amber-600 hover:text-amber-700 hover:bg-amber-50 px-2 py-1 rounded transition-colors w-fit"
