    ...
    <div v-else class="bg-white rounded-lg border border-neutral-200 shadow-sm overflow-hidden">
      <div class="px-6 py-4 border-b border-neutral-200">
        <h2 class="text-sm font-semibold text-neutral-900">
          ...
          <span class="text-neutral-500 font-normal">({{ formacaoStore.formacoes.length }})</span>
        </h2>
      </div>
            ...
            >
              ...
              <td class="px-3 py-3 sm:px-6 sm:py-4">
                <div class="flex gap-1.5">
                  ...
                  <span
                    v-if="formacao.anexo_frente && formacao.anexo_verso"
              ...
              <!-- <td class="hidden sm:table-cell px-3 py-3 sm:px-6 sm:py-4">
                <span
                  :class="[
                    'inline-flex items-center px-2 py-1 rounded-full text-xs font-medium',
                    !formacao.status ? 'bg-red-100 text-red-700' : 'bg-green-100 text-green-700',
                  ]"
                >
