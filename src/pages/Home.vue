    ...
    <div v-else class="space-y-6">
      ...
      <div class="bg-white rounded-lg border border-neutral-200 shadow-sm p-6">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-5">
          ...
          >
            <div class="p-3 bg-neutral-50 rounded-lg mb-4 group-hover:bg-neutral-100 transition-colors">
              <svg class="w-6 h-6 text-neutral-700" fill="none" viewBox="0 0 24 24" stroke="currentColor">
      ...
      <div class="bg-gradient-to-br from-neutral-50 to-neutral-100 rounded-lg border border-neutral-200 p-6">
        <div class="flex items-start gap-4">
          ...
          <div class="flex-1">
            <h3 class="text-sm font-semibold text-neutral-900 mb-1">Mantenha seus dados atualizados</h3>
            <p class="text-xs text-neutral-600 leading-relaxed">
              É importante manter suas informações pessoais, dependentes e formações sempre atualizadas.
            </p>
          </div>
        </div>
      </div>
